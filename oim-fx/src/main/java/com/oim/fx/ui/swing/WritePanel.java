...
import com.oim.fx.common.util.ColorUtil;
...
public class WritePanel extends JPanel {
	...
	private JScrollPane writeScrollPane = new JScrollPane();
	...
	public void setFontStyle(String fontName, int fontSize, Color color, boolean bold, boolean underline,
			boolean italic) {

...
public class WaitingPanel extends StackPane {
	...
	private void initData() {
		add(show_waiting, "正在发送中,请稍等。", ImageBox.getImagePath("Resources/Images/Default/Loading/loading_140_9.gif"));
		add(show_result, "消息发送失败！", ImageBox.getImagePath("Resources/Images/Default/MessageBox/message_box_warning.png"));
		show(show_waiting);
	}

...
public class HttpClientUtil {
	...
	public static String post(String url) {
		...
		return post(url, dataMap, 3000, Charset.forName("UTF-8"), Charset.forName("UTF-8"), false);
	}
	...
	public static String post(String url, Map<String, String> dataMap, int timeOut, Charset sendCharset, Charset returnCharset, boolean urlCharset) {
		...
		try {
			if (null != sendCharset) {
				postMethod.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=" + sendCharset.name());
			}

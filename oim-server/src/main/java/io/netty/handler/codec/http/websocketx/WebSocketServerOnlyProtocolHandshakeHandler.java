...
public class WebSocketServerOnlyProtocolHandshakeHandler extends WebSocketServerProtocolHandshakeHandler {
	...
	WebSocketServerOnlyProtocolHandshakeHandler(String websocketPath, String subprotocols, boolean allowExtensions, int maxFrameSize, boolean allowMaskMismatch) {
	...
	private static String getWebSocketLocation(ChannelPipeline cp, HttpRequest req, String path) {
		String protocol = "ws";
		if (cp.get(SslHandler.class) != null) {// SSL in use so use Secure WebSockets
			protocol = "wss";
		}

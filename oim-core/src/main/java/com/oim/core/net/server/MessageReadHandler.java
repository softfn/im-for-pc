...
public class MessageReadHandler implements ReadHandler {
	...
	public void setControllerFactory(ActionFactory controllerFactory) {
	...
	private Object[] getParameterValues(Parameter[] parameters, Head head, Info info, JsonObject bodyObject) {
		...
		if (null != parameters) {
			...
			for (int i = 0; i < length; i++) {
				...
				com.oim.core.common.annotation.Parameter pd = p
						.getAnnotation(com.oim.core.common.annotation.Parameter.class);
				if (null != pd) {

...
public class OnlyTextFieldUI extends BasicTextFieldUI {
	...
	protected void paintBackground(Graphics g) {
		...
		if (editor instanceof OnlyTextField) {
			OnlyTextField field = (OnlyTextField) editor;
	...
	private Color getBackground(OnlyTextField field) {

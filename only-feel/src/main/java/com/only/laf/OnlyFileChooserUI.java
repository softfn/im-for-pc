...
import com.only.OnlyRadioButtonMenuItem;
import com.only.OnlyTextField;
import com.only.box.OnlyImageBox;

public class OnlyFileChooserUI extends BasicFileChooserUI {
	...
	private static final Insets shrinkwrap = new Insets(5, 5, 5, 5);

	private JPanel centerPanel;
	private JLabel lookInLabel;

	private OnlyComboBox<File> directoryComboBox;
	...
	// private OnlyPlacesBar placesBar;
	...
	public static ComponentUI createUI(JComponent c) {
		return new OnlyFileChooserUI((JFileChooser) c);
	}

	public OnlyFileChooserUI(JFileChooser filechooser) {
		super(filechooser);
	}
	...
	private class WindowsFileChooserUIAccessor implements FilePane.FileChooserUIAccessor {
		public JFileChooser getFileChooser() {
			return OnlyFileChooserUI.this.getFileChooser();
		}

		public BasicDirectoryModel getModel() {
			return OnlyFileChooserUI.this.getModel();
		}

		public JPanel createList() {
			return OnlyFileChooserUI.this.createList(getFileChooser());
		}

		public JPanel createDetailsView() {
			return OnlyFileChooserUI.this.createDetailsView(getFileChooser());
		}

		public boolean isDirectorySelected() {
			return OnlyFileChooserUI.this.isDirectorySelected();
		}

		public File getDirectory() {
			return OnlyFileChooserUI.this.getDirectory();
		}

		public Action getChangeToParentDirectoryAction() {
			return OnlyFileChooserUI.this.getChangeToParentDirectoryAction();
		}

		public Action getApproveSelectionAction() {
			return OnlyFileChooserUI.this.getApproveSelectionAction();
		}

		public Action getNewFolderAction() {
			return OnlyFileChooserUI.this.getNewFolderAction();
		}

		@SuppressWarnings("rawtypes")
		public MouseListener createDoubleClickListener(JList list) {
			return OnlyFileChooserUI.this.createDoubleClickListener(getFileChooser(), list);
		}

		public ListSelectionListener createListSelectionListener() {
			return OnlyFileChooserUI.this.createListSelectionListener(getFileChooser());
		}
	}
	...
	protected void installIcons(JFileChooser fc) {
		...
		directoryIcon = OnlyImageBox.getClassPathIconByName("file_chooser_directory.png");
		fileIcon = OnlyImageBox.getClassPathIconByName("file_chooser_file.png");
		computerIcon = OnlyImageBox.getClassPathIconByName("file_chooser_computer.png");
		hardDriveIcon = OnlyImageBox.getClassPathIconByName("file_chooser_hard_drive.png");
		floppyDriveIcon = OnlyImageBox.getClassPathIconByName("file_chooser_floppy_drive.png");

		newFolderIcon = OnlyImageBox.getClassPathIconByName("file_chooser_new_folder.png");
		upFolderIcon = OnlyImageBox.getClassPathIconByName("file_chooser_up_folder.png");
		homeFolderIcon = OnlyImageBox.getClassPathIconByName("file_chooser_home.png");
		detailsViewIcon = OnlyImageBox.getClassPathIconByName("file_chooser_details_view.png");
		listViewIcon = OnlyImageBox.getClassPathIconByName("file_chooser_list_view.png");
		viewMenuIcon = OnlyImageBox.getClassPathIconByName("file_chooser_view_menu.png");
	}
	...
	public void installComponents(JFileChooser fc) {
		...
		OnlyPanel topPanel = new OnlyPanel();
		// topPanel.setFloatable(false);
		topPanel.putClientProperty("JToolBar.isRollover", Boolean.TRUE);
		fc.add(topPanel, BorderLayout.NORTH);// Add the top panel to the
												// fileChooser
		...
		// CurrentDir ComboBox
		directoryComboBox = new OnlyComboBox<File>() {
			public Dimension getMinimumSize() {
		...
		// Popup Menu
		final JPopupMenu viewTypePopupMenu = new OnlyPopupMenu();

		final JRadioButtonMenuItem listViewMenuItem = new OnlyRadioButtonMenuItem(filePane.getViewTypeAction(FilePane.VIEWTYPE_LIST));
		...
		final JRadioButtonMenuItem detailsViewMenuItem = new OnlyRadioButtonMenuItem(filePane.getViewTypeAction(FilePane.VIEWTYPE_DETAILS));
		...
		filenameTextField = new OnlyTextField(35) {
		...
		filterComboBox = new OnlyComboBox<FileFilter>(filterComboBoxModel);
		...
		approveButton = new OnlyButton(getApproveButtonText(fc)) {
			public Dimension getMaximumSize() {
		...
		cancelButton = new OnlyButton(cancelButtonText) {
			public Dimension getMaximumSize() {
				return approveButton.getPreferredSize().width > cancelButton.getPreferredSize().width ? approveButton.getPreferredSize() : cancelButton.getPreferredSize();
			}
		};
	...
	private void updateUseShellFolder() {
		...
		// placesBar = new OnlyPlacesBar(fc);
	...
	protected void installListeners(JFileChooser fc) {
		...
		ActionMap actionMap = getOnlyActionMap();
		SwingUtilities.replaceUIActionMap(fc, actionMap);
	}

	ActionMap getOnlyActionMap() {

		return createOnlyActionMap();
	}

	ActionMap createOnlyActionMap() {
		...
		// };
		//
		// map.put(FilePane.ACTION_APPROVE_SELECTION,
	...
	private static JButton createToolButton(Action a, Icon defaultIcon, String toolTipText, String accessibleName) {
		final OnlyButton result = new OnlyButton(a);

		Image normalImage = OnlyImageBox.getClassPathImageByName("button_border_normal.png");
		Image rolloverImage = OnlyImageBox.getClassPathImageByName("button_border_rollover.png");
		Image pressedImage = OnlyImageBox.getClassPathImageByName("button_border_pressed.png");
		Image focusImage = OnlyImageBox.getClassPathImageByName("button_border_foucs.png");
		Image disabledImage = OnlyImageBox.getClassPathImageByName("button_border_disabled.png");

		result.setNormalImage(normalImage);
		result.setRolloverImage(rolloverImage);
		result.setPressedImage(pressedImage);
		result.setFocusImage(focusImage);
		...
		result.putClientProperty(HI_RES_DISABLED_ICON_CLIENT_KEY, Boolean.TRUE);

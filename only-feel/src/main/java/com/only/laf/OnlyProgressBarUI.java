...
public class OnlyProgressBarUI extends BasicProgressBarUI {
	...
	private static final Image BG_IMAGE_H = OnlyImageBox.getClassPathImageByName("progress/progress_bar_background_h.png");
	private static final Image BG_IMAGE_V = OnlyImageBox.getClassPathImageByName("progress/progress_bar_background_v.png");

	private static final Image IMAGE_H = OnlyImageBox.getClassPathImageByName("progress/progress_bar_h.png");
	private static final Image IMAGE_V = OnlyImageBox.getClassPathImageByName("progress/progress_bar_v.png");

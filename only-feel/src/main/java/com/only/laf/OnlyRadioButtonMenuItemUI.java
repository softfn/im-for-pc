...
public class OnlyRadioButtonMenuItemUI extends OnlyMenuItemUI {
	
	private static final Icon DEFAULT_ICON = UIBox.getIcon(UIBox.key_icon_menu_radio_button_item_selected);

	public static ComponentUI createUI(JComponent c) {
		return new OnlyRadioButtonMenuItemUI();
	}
	...
	protected Color getTextColor() {
		...
		if (menuItem instanceof OnlyRadioButtonMenuItem) {
			OnlyRadioButtonMenuItem cItem = (OnlyRadioButtonMenuItem) menuItem;

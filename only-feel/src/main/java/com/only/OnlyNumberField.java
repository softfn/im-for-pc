...
public class OnlyNumberField extends OnlyTextField implements Serializable {
	...
	public OnlyNumberField(int maxLength, int decimalLength) {
		this(maxLength, decimalLength, Double.MAX_VALUE);
	}

	public OnlyNumberField(int maxLength, int decimalLength, double maxRange) {
		super();

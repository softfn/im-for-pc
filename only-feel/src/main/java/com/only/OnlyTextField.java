...
import com.only.laf.OnlyTextFieldUI;
import com.only.util.OnlyUIUtil;

public class OnlyTextField extends JTextField {
	...
	public OnlyTextField() {
		this(null, null, 0);
	}

	public OnlyTextField(String text) {
		this(null, text, 0);
	}

	public OnlyTextField(int columns) {
		this(null, null, columns);
	}

	public OnlyTextField(String text, int columns) {
		this(null, text, columns);
	}

	public OnlyTextField(Document doc, String text, int columns) {
		super(doc, text, columns);
		setUI(new OnlyTextFieldUI());
		...
		normalBorder = UIBox.getBorder(UIBox.key_border_text_field_normal);
		rolloverBorder = UIBox.getBorder(UIBox.key_border_text_field_rollover);
		disabledBorder = UIBox.getBorder(UIBox.key_border_text_field_disabled);
		notEditableBorder = UIBox.getBorder(UIBox.key_border_text_field_not_editable);
		notEditableRolloverBorder = UIBox.getBorder(UIBox.key_border_text_field_not_editable_rollover);

...
package com.only.common.image.gif;
...
public class GifDecoder {
	...
	private int dispose = 0; // 0=no action; 1=leave in place; 2=restore to bg;
								// 3=restore to prev
	...
	protected void readImage() {
		...
		frames.add(new GifFrame(currentBufImg, delay)); // add image to frame
														// list

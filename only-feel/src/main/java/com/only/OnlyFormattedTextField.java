...
import com.only.laf.OnlyFormattedTextFieldUI;
import com.only.util.OnlyUIUtil;

public class OnlyFormattedTextField extends JFormattedTextField {
    ...
    public OnlyFormattedTextField() {
        super();
        init();
    }

    public OnlyFormattedTextField(Object value) {
        super(value);
        init();
    }

    public OnlyFormattedTextField(Format format) {
        super(format);
        init();
    }

    public OnlyFormattedTextField(AbstractFormatter formatter) {
        super(formatter);
        init();
    }

    public OnlyFormattedTextField(AbstractFormatterFactory factory) {
        super(factory);
        init();
    }

    public OnlyFormattedTextField(AbstractFormatterFactory factory, Object currentValue) {
        super(factory, currentValue);
        init();
    }

    public void init() {
        setUI(new OnlyFormattedTextFieldUI());
        ...
        normalBorder = UIBox.getBorder(UIBox.key_border_formatted_text_field_normal);
		rolloverBorder = UIBox.getBorder(UIBox.key_border_formatted_text_field_rollover);
		disabledBorder = UIBox.getBorder(UIBox.key_border_formatted_text_field_disabled);
		notEditableBorder = UIBox.getBorder(UIBox.key_border_formatted_text_field_not_editable);
		notEditableRolloverBorder = UIBox.getBorder(UIBox.key_border_formatted_text_field_not_editable_rollover);

...
import com.only.laf.OnlyCheckBoxListCellRenderer;
...
public class OnlyCheckBoxList<E> extends OnlyList<E> implements ListDataListener {
	...
	public OnlyCheckBoxList() {
		super();
		init();
	}

	@SuppressWarnings("rawtypes")
	public OnlyCheckBoxList(ListModel dataModel) {
		super(dataModel);
		init();
	}

	public OnlyCheckBoxList(Object[] listData) {
		super(listData);
		init();
	}

	public OnlyCheckBoxList(Vector<?> listData) {
		super(listData);
		init();
	}
	...
	private void init() {
		...
		setCellRenderer(new OnlyCheckBoxListCellRenderer.UIResource(selectedList));
	...
	private class MouseListener extends MouseAdapter {
		public void mouseReleased(MouseEvent e) {
			OnlyCheckBox box = (OnlyCheckBox) getCellRenderer();

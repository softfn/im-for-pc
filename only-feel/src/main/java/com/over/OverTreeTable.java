...
import com.over.component.tree.OverTreeColumnCellEditor;
import com.over.component.tree.OverTreeTableCellRenderer;
...
public class OverTreeTable extends JTable {

    private static final long serialVersionUID = -8142407744125469821L;
    private OverTreeTableCellRenderer tree;
    private CommonTreeTableModel model;
    private boolean paintTreeLines;
    private Map<Integer, Integer> treeRendererTextStartMap;

    public OverTreeTable(CommonTreeTableModel model) {
        super();
        this.model = model;
        init();
    }

    public OverTreeTable(DefaultMutableTreeNode root, String[] columnsName, Class<?>[] columnsClass,
    ...
    private void init() {
        ...
        tree = new OverTreeTableCellRenderer(this, model);
        setRowHeight(20);
        setModel(model);
        getColumn(model.getColumnName(0)).setCellRenderer(tree);
        getColumn(model.getColumnName(0)).setCellEditor(new OverTreeColumnCellEditor());
    ...
    private class MouseHandler extends MouseAdapter {
        ...
        final JTable table = OverTreeTable.this;
